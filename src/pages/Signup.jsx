...
const Signup = () => {
  ...
  const sendOtp = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://griet-hub-backend.onrender.com/api/auth/register", {
        method: "POST",
  ...
  const verifyOtp = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://griet-hub-backend.onrender.com/api/auth/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
